...
export default function Games() {
    ...
    useEffect(() => {
        ...
        if (location.state && location.state.query) url = location.state.query;
            ...
            if (location.state && location.state.type == "date") {url = buildQuery(location.state.name);}
        ...
        <div className="games">
            ...
            <div className="custom">
                ...
                <div>
                    ...
                    <div onClick={() => setDisplay(0)} className={!display ? "curdisplay" : null}>
                    ...
                    <div onClick={() => setDisplay(1)} className={display ? "curdisplay" : null}>
                        <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#5f6368">
            ...
            </div>
            {
                loading ? 
                <Loading /> :
                <div className={`main ${display? "single" : null}`}>
                    {
                        games.length ? 
                        games.map((game) => {
                            let imgs = [];
                            ...
                            return <GameCard key={game.id} str={str} game={game} imgs={imgs} className = "game" displayStyle={display}/>
                        }) : 
                        <h1>Nothing!</h1>
                    }
                </div>
