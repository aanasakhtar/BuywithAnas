const res = (() => {
    ...
    let cartFunctionality = (() => {
        ...
        function addToCart({image, name, price, id, cb}) {
            cart.push({image, name, price, id, cb});
            if (cb) cb(true)
        }
        ...
        function doesContain(id) {
          ...
          return {
            getCart, clearCart, addToCart, getTotalPrice, removeFromCart, getLength, doesContain
          };
        })();
    return { platforms, genres, ky, baseURL, platform_icons, page_size, date, cartFunctionality}
  })();
export default res;