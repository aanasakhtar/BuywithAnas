...
export default function Navigation({mobcb}) {
    ...
    return (
        <div className="navigation">
            <p>New Releases</p>
            <Link to='/shop/games/p' state={{name: 'Last 30 days', type: 'date'}} className={selected == 'Last 30 days' ? "selected" : ''} onClick={(e) => { e.stopPropagation();handleClick('Last 30 days') }}>
                <div>
            ...
            <Link to='/shop/games/p' state={{name: 'This week', type: 'date'}} className={selected == 'This week' ? "selected" : ''} onClick={(e) => { e.stopPropagation();handleClick('This week') }}>
                <div>
            ...
            <Link to='/shop/games/p' state={{name: 'Next week', type: 'date'}} className={selected == 'Next week' ? "selected" : ''} onClick={(e) => { e.stopPropagation();handleClick('Next week') }}>
                <div>
            ...
            <p>Top</p>
            <Link to='/shop/games/p'  state={{name: 'Best of the year', type: 'date'}} className={selected == 'Best of the year' ? "selected" : ''} onClick={(e) => { e.stopPropagation(); handleClick('Best of the year') }}>
                <div>
            ...
            <Link to='/shop/games/p' state={{name: 'Popular in ' + String(res.date.getFullYear() - 1), type: 'date'}} className={selected == 'Popular' ? "selected" : ''} onClick={ (e) => {e.stopPropagation(); handleClick('Popular') }}>
                <div>
            ...
            <Link to='/shop/games/p' state={{name: 'All time top', type: 'other'}} className={selected == 'All time top' ? "selected" : ''} onClick={(e) => { e.stopPropagation(); handleClick('All time top') }}>
                <div>
            ...
            <p>Platforms</p>
            {
                res.platforms.map((platform) => {
                    ...
                    return (
                        <Link to='/shop/games/p' state={{name: platform.name, type: 'platform', id: platform.id}} className={selected == platform.name ? "selected" : ''} onClick={(e) => { e.stopPropagation(); handleClick(platform.name) }} key={platform.id}>
                            <div>
                                {
                                    platform.icon
                                }
            ...
            <button onClick={() => {setShowPlatforms((prev) => !prev)}}>
                <div>
            ...
            <p>Genres</p>
            {
                res.genres.map((genre) => {
                    ...
                    return (
                        <Link to='/shop/games/p'  state={{name: genre.name, type: 'genre', id: genre.id}} className={selected === genre.name ? "selected" : ''} onClick={(e) => { e.stopPropagation(); handleClick(genre.name) }} key={genre.id}>
                            <div>
            ...
            <button onClick={() => setShowGenres((prev) => !prev)}>
                <div>
